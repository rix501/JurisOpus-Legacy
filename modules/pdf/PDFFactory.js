...
var PDFFactory = function(municipio, name, data){
    ...
    if(_.isArray(data)){
        ...
        doc = templates[municipio][name](doc, data);
    }    
...
templates.SanJuan.OcupacionIlegal = function(doc, nombre){
    var y, x, width, height;
    ...
    doc.text('DESAHUCIO EN PRECARIO',320,0,{
        width:230,
        align:'center'
    });     

    doc.text('DEMANDA',1,doc.y + 20,{
        width: 612,
        align: 'center',
        lineGap: 10
    });
    ...
    .text("2. La parte Demandada ocupa el apartamento «APARTAMENTO» en el edificio «EDIFICIO» de dicho complejo en calidad de precarista, sin que medie un contrato de arrendamiento, o autorización alguna para ello.",{
        indent: 72,
        align: 'justify',
        lineGap: 10
    })
    ...
    .text("4. Por esta razón la parte compareciente se ha visto obligada a presentar la presente acción.*",{
        indent: 72,
        align: 'justify',
        lineGap: 10
    })
    ...
    doc.text("*17 LPRA sección 103", 80, doc.y)
    .text("**La parte Demandante renuncia al término de diez (10) días para señalar vista contenido en la Ley #129 de 27 de septiembre de 2007." ,{
        align: 'justify'
    });


    drawFooterLine(doc, doc.x,  doc.y - 5);
